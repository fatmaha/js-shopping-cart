...
eval("const { default:axios} = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\r\n\r\nclass Cart{\r\n\r\n    #baseUrl = 'https://fakestoreapi.com/products';\r\n    async list(){\r\n        return await axios.get(this.#baseUrl);\r\n    }\r\n\r\n    async create(data){\r\n        return await axios.post(this.#baseUrl, data)\r\n    }\r\n\r\n    async update(id, data){\r\n        return await axios.put(`${this.#baseUrl}/${id}`, data)\r\n    }\r\n\r\n    async delete(id){\r\n        return await axios.delete(`${this.#baseUrl}/${id}`)\r\n    }\r\n}\r\n\r\nmodule.exports = new Cart\n\n//# sourceURL=webpack:///./src/services/Cart.js?");
